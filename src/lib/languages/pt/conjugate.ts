 ...
 */
import { PT_PERSON_IDS as PERSON_IDS, PT_TENSE_IDS as TENSE_IDS, type PtPersonId as PersonId, type PtTenseId as TenseId } from './tenses.js'
import type { Conjugation, Forms } from '../../grammar/tenses.js'
